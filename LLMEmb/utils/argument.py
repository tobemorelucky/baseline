...
def get_main_arguments(parser):
    ...
    parser.add_argument("--dataset",
                        default="yelp",
                        choices=["yelp", "fashion", "beauty", "ml-1m", "toys"],
...
def get_model_arguments(parser):
    ...
    parser.add_argument("--fixed_eval_neg",
                        default=0,
                        type=int,
                        help="whether use fixed negative samples for evaluation (0: random, 1: fixed)")
    parser.add_argument("--valid_neg_file",
                        default="valid_neg.pkl",
                        type=str,
                        help="the file name of valid neg (under data/<dataset>/handled/)")
    parser.add_argument("--test_neg_file",
                        default="test_neg.pkl",
                        type=str,
                        help="the file name of test neg (under data/<dataset>/handled/)")
    parser.add_argument("--valid_pos_file",
                        default="valid_pos.pkl",
                        type=str,
                        help="the file name of valid pos (under data/<dataset>/handled/)")
    parser.add_argument("--test_pos_file",
                        default="test_pos.pkl",
                        type=str,
                        help="the file name of test pos (under data/<dataset>/handled/)")
